  ...
  return (
    <div className="form-section">
      ...
      <div className="form-grid">
        ...
        <motionJenisKelamin form={form} onChange={onChange} disabled={disabled} />
        ...
        <motionAgama form={form} onChange={onChange} disabled={disabled} />
        <motionAlamat form={form} onChange={onChange} disabled={disabled} />
...
function motionJenisKelamin({ form, onChange, disabled }) {
  return (
...
function motionAgama({ form, onChange, disabled }) {
  return (
    <div className="input-group">
...
function motionAlamat({ form, onChange, disabled }) {
  return (
