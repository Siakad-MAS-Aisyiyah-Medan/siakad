...
import { useAdminPpdb } from '../hooks/useAdminPpdb';
    ...
    <AdminPageShell>
      <div className="data-panel view-list">
        <div className="panel-header glass">
          <motionHeaderText />
          <motionFilters ppdb={ppdb} />
        </div>
        <motionStatsGrid stats={ppdb.stats} />
...
function motionStatsGrid({ stats }) {
  return (
