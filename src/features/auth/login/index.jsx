...
import { login, saveSession, getRedirectPathForRole } from '../../../services/auth.service';
...
export default function LoginPage() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const target = redirect_path || getRedirectPathForRole(user.role);
    ...
    <div className="login-container">
      ...
      <div className="login-form-side">
        <div className="form-card animate-fade-in">
          ...
          <footer>
            <p>
              Belum memiliki akun? <Link to="/register">Daftar Akun Calon Siswa</Link>
            </p>
